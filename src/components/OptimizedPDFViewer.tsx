...
export function OptimizedPDFViewer({ file, pageNumber, className = '' }: OptimizedPDFViewerProps) {
  ...
  return (
    <div ref={containerRef} className={`relative border border-gray-200 rounded-lg overflow-hidden bg-white ${className}`}>
      {/* Loading indicator */}
      {isLoading && (
      ...
      {!isLoading && !error && (
        <div className="absolute top-2 right-2 flex space-x-1">
          <button
            ...
            className="p-1.5 bg-white/90 hover:bg-white rounded shadow-sm border border-gray-200 transition-colors"
