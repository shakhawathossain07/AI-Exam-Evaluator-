    ...
    <EvaluationErrorBoundary onError={(error) => console.error('Review component error:', error)}>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-amber-800 mb-2">Review AI Evaluation</h2>
      ...
      {results.metadata?.studentInfo && (
        ...
        <motion.div
          ...
          className="bg-indigo-50/80 backdrop-blur-sm rounded-xl border border-indigo-200/50 p-6"
        >
            ...
            {results.metadata.studentInfo.studentName && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-indigo-800 font-semibold">{results.metadata.studentInfo.studentName}</p>
                </div>
              </div>
            )}
            {results.metadata.studentInfo.studentId && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-indigo-800 font-semibold">{results.metadata.studentInfo.studentId}</p>
                </div>
              </div>
            )}
            {results.metadata.studentInfo.subject && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-indigo-800 font-semibold">{results.metadata.studentInfo.subject}</p>
                </div>
              </div>
            )}
            {results.metadata.studentInfo.examType && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-indigo-800 font-semibold">{results.metadata.studentInfo.examType}</p>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <h3 className="text-sm font-medium text-gray-600 mb-1">Total Score</h3>
          <p className="text-2xl font-bold text-gray-800">
            {calculatedTotals.totalAwarded} / {calculatedTotals.totalPossible}
          </p>
          {/* Add accuracy indicator */}
          <p className="text-xs text-green-600 mt-1">✓ Calculation Verified</p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <h3 className="text-sm font-medium text-gray-600 mb-1">Percentage</h3>
          <p className="text-2xl font-bold text-gray-800">
            {calculatedTotals.percentage ? `${calculatedTotals.percentage.toFixed(1)}%` : 'N/A'}
          </p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <h3 className="text-sm font-medium text-gray-600 mb-1">Grade</h3>
          <p className={`text-2xl font-bold ${
            calculatedTotals.grade?.color === 'green' ? 'text-green-600' :
            calculatedTotals.grade?.color === 'blue' ? 'text-blue-600' :
            calculatedTotals.grade?.color === 'yellow' ? 'text-yellow-600' :
            calculatedTotals.grade?.color === 'orange' ? 'text-orange-600' :
            'text-red-600'
          }`}>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Chief Examiner's Feedback</h3>
        <textarea
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-800">Question-by-Question Review</h3>
             ...
             return (
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h5 className="text-sm font-semibold text-indigo-600 uppercase tracking-wide">
                    ...
                    {primaryFile ? (
                      ...
                      <div className="border border-gray-200 rounded-lg p-8 text-center bg-gray-50">
                        ...
                        <p className="text-gray-500">No student paper available</p>
                      </div>
                    )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-700 whitespace-pre-wrap">{question.evaluation}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-700 whitespace-pre-wrap">{question.justification}</p>
                      )}
                    </div>
