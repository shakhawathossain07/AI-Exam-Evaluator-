    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-700 rounded-xl focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 bg-slate-800/50 text-white"
              >
                {['1', '2', '3', '4', '5', '6'].map(num => (
          ...
          <div className="space-y-3">
            <label className="flex items-center space-x-2">
              <input
                ...
                className="rounded border-slate-600 text-cyan-500 focus:ring-cyan-500/50 bg-slate-800"
              />
              <span className="text-sm text-slate-300">Include examiner guidance notes</span>
            </label>
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                className="rounded border-slate-600 text-cyan-500 focus:ring-cyan-500/50 bg-slate-800"
              />
              <span className="text-sm text-slate-300">Include alternative acceptable answers</span>
            </label>
          </div>

          {/* Mark Scheme Preview Info */}
          <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-2xl p-4">
            <h4 className="font-medium text-cyan-400 mb-2">Mark Scheme Features</h4>
      ...
      <div className="flex justify-center">
        <motion.button
          ...
          className="flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-xl hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-emerald-500/25"
        >
          {isGenerating ? (
            <>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-xl hover:opacity-90 transition-all shadow-lg shadow-emerald-500/25"
            >
          ...
          <div className="bg-slate-800/50 rounded-xl p-4 max-h-96 overflow-y-auto border border-slate-700/50">
