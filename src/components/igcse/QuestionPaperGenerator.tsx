    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                {['1', '2', '3', '4', '5', '6'].map(num => (
                  <option key={num} value={num} className="bg-slate-900">Paper {num}</option>
                ))}
              </select>
            </div>
            ...
            <div>
              ...
              >
                {['1', '2', '3'].map(num => (
                  <option key={num} value={num} className="bg-slate-900">Variant {num}</option>
                ))}
              </select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-xl focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 text-white"
              >
                <option value="m25" className="bg-slate-900">May/June 2025</option>
                <option value="s25" className="bg-slate-900">Oct/Nov 2025</option>
                <option value="w25" className="bg-slate-900">Feb/Mar 2025</option>
              </select>
            </div>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">Question Generation</label>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
            <h4 className="font-medium text-amber-300 mb-2 flex items-center space-x-2">
              <BookOpen className="w-4 h-4" />
              <span>Cambridge IGCSE Reference Guide</span>
            </h4>
            <div className="text-sm text-amber-300/80 space-y-2">
              <div>
                <p className="font-medium text-amber-200">What is a Variant?</p>
                <p>Variants are different versions of the same paper given in different time zones:</p>
                <p>• <strong className="text-amber-200">Variant 1:</strong> Asia/Australia time zones</p>
                <p>• <strong className="text-amber-200">Variant 2:</strong> Middle East/Africa time zones</p>
                <p>• <strong className="text-amber-200">Variant 3:</strong> Americas time zones</p>
                <p>All variants test the same content at the same difficulty level.</p>
              </div>
              
              <div>
                <p className="font-medium text-amber-200">Session Codes:</p>
                <p>• <strong className="text-amber-200">m25:</strong> May/June 2025 examination session</p>
                <p>• <strong className="text-amber-200">s25:</strong> October/November 2025 session</p>
                <p>• <strong className="text-amber-200">w25:</strong> February/March 2025 session</p>
              </div>
              
              <div>
                <p className="font-medium text-amber-200">File Naming Convention:</p>
                <p><code className="bg-slate-800/50 px-1.5 py-0.5 rounded text-amber-200">0653_m25_qp_12</code> = Subject Code_Session_Question Paper_Paper Number + Variant</p>
      ...
      <div className="flex justify-center">
        <motion.button
          ...
          className="flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl hover:shadow-lg hover:shadow-cyan-500/25 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
          {isGenerating ? (
            <>
      ...
      {generatedPaper && (
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                disabled={!pdfBlob}
                className="flex items-center space-x-2 px-4 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-blue-500/25"
              >
              ...
              <button
                ...
                disabled={!pdfBlob}
                className="flex items-center space-x-2 px-4 py-2 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-emerald-500/25"
              >
          ...
          <div className="bg-white border rounded-xl p-6 overflow-y-auto shadow-inner max-h-[80vh]">
            <div className="cambridge-paper-preview font-[Times_New_Roman] leading-snug text-black">
