    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        if (msg.includes('429') || msg.includes('quota') || msg.includes('rate limit') || msg.includes('resource_exhausted')) {
          errorMessage = 'AI service quota exceeded. The Gemini API free tier limit has been reached. Please try again later or contact the administrator to upgrade the API plan.';
        } else if (msg.includes('401') || msg.includes('unauthorized')) {
          errorMessage = 'API authentication failed. Please contact the administrator.';
                ...
                <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/5 backdrop-blur-sm p-6 rounded-xl border border-cyan-500/20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      <label htmlFor="examType" className="block text-sm font-medium text-slate-300 mb-2">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all text-white"
                        disabled={evaluationState.isLoading}
                      >
